...
#warning Reachability case needed also!
                ...
                [[[UIAlertView alloc] initWithTitle:nil message:NSLocalizedString(@"KL_STR_MAIL_COMPOSER_ERROR_DESCRIPTION_FOR_INVITE", nil) delegate:nil cancelButtonTitle:NSLocalizedString(@"KL_STR_CANCEL", nil) otherButtonTitles:nil] show];
