...
typedef NS_ENUM(NSUInteger, KLPlaceholderTextViewStyle) {
    KLPlaceholderTextViewStylePlain,
    KLPlaceholderTextViewStyleBordered,
};

@implementation KLPlaceholderTextView
...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer {
    ...
    if (self) {
        [self configureTextViewWithStyle:KLPlaceholderTextViewStyleBordered];
    }
    return self;
}
...
- (void)awakeFromNib {
    [super awakeFromNib];
    [self configureTextViewWithStyle:KLPlaceholderTextViewStylePlain];
}

- (void)configureTextViewWithStyle:(KLPlaceholderTextViewStyle)textViewStyle {
    
    [self setTranslatesAutoresizingMaskIntoConstraints:NO];
    
    if (textViewStyle == KLPlaceholderTextViewStyleBordered) {
