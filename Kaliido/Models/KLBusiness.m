...
- (NSDictionary *) toDictionary {
    ...
    for (KLInterest *interest in self.interests) {
        KLInterestID* tmp = [[KLInterestID alloc] init];
        tmp.InterestID = [NSNumber numberWithUnsignedInteger:interest.ID];
        [interestIDArray addObject:tmp];
//        [interestIDArray addObject:[NSNumber numberWithUnsignedInteger:1]];
    }
    [[super class] addItemToDictionary:dict key:@"Interests" value:@{@"Array":interestIDArray} default:@{@"Array":@[]}];
